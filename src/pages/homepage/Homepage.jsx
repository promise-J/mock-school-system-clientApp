...
function Homepage() {
  ...
  return (
    <div className="homepage">
      ...
      <AliceCarousel
        style={{ background: "red", padding: 20, width: "100vw" }}
        autoPlay
      ...
      <div className="welcome" data-aos="zoom-in-right">
        ...
        <p data-aos="fade-up">
          ...
          the stars to change the world. The future belongs to those who believe
      ...
      <div className="image-voice">
        ...
        <div className="single-image-voice" data-aos="fade-right">
          <div className="single-content">
            ...
            <p>
              Every organisation that is headed aright have standards and we are
              not...
            </p>
            <h1>OUR STANDARDS</h1>
          </div>
      ...
      <div className="image-voice">
        <div className="single-image-voice" data-aos="fade-left">
          <div className="single-content">
            ...
            <p>
              Even thought you have seen enough in construction and Engineering
              field? Check this club out.
            </p>
        ...
        <div className="single-image-voice" data-aos="fade-left">
          <div className="single-content">
            <Link to="/clubs">Read More</Link>
            <p>
              This is the center of Home Responsibility. Home dishes are taught
              and served Hot here.
            </p>
        ...
        <div className="single-image-voice" data-aos="fade-left">
          <div className="single-content">
            <Link to="/clubs">Read More</Link>
            <p>
              The generations of AI. We Know just how much the world depends on
              Computer that is why we are committed to this course.
            </p>
            <h1>Computer Club</h1>
          </div>
        </div>
      ...
      <div className="recommendations">
        <div className="recommendation" data-aos="zoom-in-up">
          <p>
            "Resonance is the best School by far in Awka North as far as quality
            is concerned"
          </p>
